(function () {
  ...
  const stampDutyData = {
    "andhra-pradesh": {
      ...
      seo: {
        title: "AP Stamp Duty Calculator 2025 â€” Andhra Pradesh Property Registration | Calculatorcity",
      ...
      <p>The stamp duty is calculated on the higher of: (1) the actual transaction value, or (2) the government-declared circle rate (also called market value guideline) for that locality. If you buy a property for â‚¹50 lakhs but the circle rate is â‚¹60 lakhs, stamp duty is calculated on â‚¹60 lakhs.</p>
      ...
      <p>Original sale deed, parent documents, Pattadar passbook (for agricultural land), Encumbrance Certificate (EC), identity proof of buyer and seller, two witnesses with ID proof, and demand draft for stamp duty and registration charges payable to the Sub-Registrar.</p>`,
        faq: [
          ...
          { q: "What is the registration fee for property in AP?", a: "Registration charges in AP are 1.5% of the property value or circle rate (whichever is higher). There is no upper cap on registration fees in AP. For a â‚¹50 lakh property, the registration charge would be â‚¹75,000. This is in addition to stamp duty (â‚¹2.50 lakh) and transfer duty (â‚¹75,000)." }
        ]
      }
    },
    ...
    telangana: {
      ...
      seo: {
        title: "Telangana Stamp Duty Calculator 2025 â€” TS Property Registration | Calculatorcity",
      ...
      content: {
        howItWorks: `<p>Telangana charges stamp duty at <strong>4% of the property value</strong>, which is lower than Andhra Pradesh (5%). The registration charge is just 0.5% â€” one of the lowest in South India. However, a transfer duty of 1.5% is additionally levied, making the effective total approximately 6% of property value.</p>
      <p>Telangana's IGRS (Inspector General of Registration and Stamps) department manages property registrations. The state's Dharani portal handles agricultural land mutations while urban property registrations go through the Registration department.</p>`,
        stateSpecific: `<h2>IGRS Telangana â€” property registration</h2>
    ...
    karnataka: {
      ...
      belowMinStamp: 2,
      notes: "KA: 2% for properties below â‚¹20L, 3% for â‚¹20L-â‚¹45L, 5% above â‚¹45L. Different for affordable housing.",
      seo: {
        title: "Karnataka Stamp Duty Calculator 2025 â€” Property Registration KA | Calculatorcity",
        ...
        subtitle: "Karnataka property stamp duty â€” rates vary by property value. Bengaluru and all KA districts."
      },
      content: {
        howItWorks: `<p>Karnataka has a <strong>tiered stamp duty structure</strong> based on property value: 2% for properties below â‚¹20 lakhs, 3% for properties between â‚¹20 lakhs and â‚¹45 lakhs, and 5% for properties above â‚¹45 lakhs. Registration charges are 1% across all categories.</p>
      <p>This tiered structure makes Karnataka relatively affordable for first-time homebuyers purchasing properties in the â‚¹20-45 lakh range. The KAVERI portal (kaveri.karnataka.gov.in) manages all property registration services.</p>`,
      ...
      <h2>KAVERI portal â€” Karnataka registration</h2>
      <p>The KAVERI (Karnataka Valuation and E-Registration) portal allows online appointment booking, property valuation lookup, stamp duty payment, and document upload. This has significantly reduced registration time in Karnataka.</p>`,
        faq: [
          { q: "What is stamp duty in Karnataka 2025?", a: "Karnataka stamp duty depends on property value: 2% for below â‚¹20 lakhs, 3% for â‚¹20 lakhs to â‚¹45 lakhs, and 5% for above â‚¹45 lakhs. Registration charges are 1% across all values. Total cost: 3% (below 20L), 4% (20-45L), or 6% (above 45L)." },
          ...
          { q: "How is stamp duty calculated for Bengaluru property?", a: "For a â‚¹80 lakh Bengaluru flat: stamp duty = 5% Ã— â‚¹80L = â‚¹4,00,000. Registration = 1% Ã— â‚¹80L = â‚¹80,000. Total = â‚¹4,80,000. Note: if the guideline value is higher than â‚¹80L, calculation is on the guideline value." },
    ...
    "tamil-nadu": {
      ...
      seo: {
        title: "Tamil Nadu Stamp Duty Calculator 2025 â€” TN Property Registration | Calculatorcity",
        ...
        subtitle: "TN property stamp duty â€” 7% stamp duty + 4% registration. Highest in South India."
      },
      content: {
        howItWorks: `<p>Tamil Nadu has the <strong>highest property registration cost in South India</strong> â€” stamp duty at 7% plus registration charges at 4%, totalling 11% of property value. This is significantly higher than neighbouring Telangana (6%) and Karnataka (4-6%).</p>
      ...
      <p>The TNREGINET portal (tnreginet.gov.in) allows you to check guideline values for any area in Tamil Nadu, search encumbrance certificates, book appointments, and check registration status.</p>`,
        faq: [
          { q: "What is stamp duty in Tamil Nadu 2025?", a: "Tamil Nadu stamp duty is 7% of property value, and registration charges are 4% â€” giving a total of 11%. This is the highest combination in South India. For a â‚¹50 lakh property: stamp duty = â‚¹3.5 lakhs, registration = â‚¹2 lakhs, total = â‚¹5.5 lakhs additional cost." },
          ...
          { q: "How to calculate stamp duty for Chennai property?", a: "For a Chennai flat of â‚¹80 lakhs: Stamp duty = 7% Ã— â‚¹80L = â‚¹5,60,000. Registration = 4% Ã— â‚¹80L = â‚¹3,20,000. Total additional cost = â‚¹8,80,000. This is calculated on guideline value or transaction value, whichever is higher." },
    ...
    maharashtra: {
      ...
      minimumValue: null,
      notes: "Women get 1% discount in MH. Metro cess 1% extra in Mumbai and metro areas. Registration capped at â‚¹30,000 for some categories.",
      seo: {
        title: "Maharashtra Stamp Duty Calculator 2025 â€” Mumbai Property Registration | Calculatorcity",
        ...
        subtitle: "MH property stamp duty â€” women get 1% discount. Mumbai, Pune, Nagpur all districts."
      },
      content: {
        howItWorks: `<p>Maharashtra stamp duty is <strong>5% for men and 4% for women</strong> buyers â€” one of the few states offering a meaningful women discount. For joint registrations, the effective rate is 4.5%. Registration charges are 1% of the property value.</p>
      ...
      <p>The Maharashtra IGR (Inspector General of Registration) manages property registrations through the iSarita portal.</p>`,
        stateSpecific: `<h2>Mumbai property â€” Metro Cess</h2>
      ...
      <p>Women buyers in Maharashtra pay 4% stamp duty vs 5% for men â€” saving 1% of the property value. For a â‚¹1 crore property, women save â‚¹1 lakh. For joint registration where at least one co-owner is female, the rate is 4.5%.</p>
      <h2>iSarita portal â€” Maharashtra registration</h2>
      <p>The iSarita portal (igrmaharashtra.gov.in) handles all property registration in Maharashtra. You can search ready reckoner rates, book appointments, pay stamp duty, and track document status.</p>`,
        faq: [
          ...
          { q: "What is the women discount on stamp duty in Maharashtra?", a: "Women buyers in Maharashtra pay 4% stamp duty instead of 5% â€” a saving of 1% of property value. For a â‚¹75 lakh property, women save â‚¹75,000 on stamp duty. For joint purchase with a woman as co-owner, the rate is 4.5%. The property must be in the woman's name to avail this benefit." },
    ...
    delhi: {
      ...
      minimumValue: null,
      notes: "Delhi gives 2% discount for women â€” biggest women discount in India. Registration capped at specific amounts in some cases.",
      seo: {
        title: "Delhi Stamp Duty Calculator 2025 â€” Property Registration Delhi | Calculatorcity",
        ...
        subtitle: "Delhi stamp duty â€” women pay 4%, men pay 6%. Biggest women discount in India."
      },
      content: {
        howItWorks: `<p>Delhi has the <strong>biggest women discount on stamp duty in India</strong> â€” women pay just 4% stamp duty while men pay 6%. Registration charges are 1% for all. For a joint purchase, the rate depends on whether a woman is the primary owner.</p>
      <p>Delhi's stamp duty is among the lower rates for men (6%) and the lowest for women (4%) among major Indian cities. The Delhi government periodically offers additional stamp duty rebates to boost the real estate market.</p>`,
        stateSpecific: `<h2>Delhi women stamp duty â€” biggest saving in India</h2>
      <p>Delhi women buyers save 2% on stamp duty â€” the highest women discount in any Indian state. On a â‚¹1 crore property, women save â‚¹2 lakhs in stamp duty compared to men. This is double the savings compared to Maharashtra (1%) and Haryana (2% but lower base rates).</p>
      ...
      <p>Delhi has 8 categories of circle rates (A to H) depending on the colony/area. Category A (premium areas like Shanti Niketan, Vasant Vihar) has the highest circle rates. Category H (unapproved colonies) has the lowest. Stamp duty is calculated on circle rate or transaction value, whichever is higher.</p>`,
        faq: [
          ...
          { q: "What is the women discount on stamp duty in Delhi?", a: "Women buyers in Delhi pay only 4% stamp duty vs 6% for men â€” a saving of 2%. For a â‚¹80 lakh property, women save â‚¹1,60,000 on stamp duty. This is the largest women discount in India. The property deed must be in the woman's name to avail this rate." },
          { q: "What are Delhi circle rate categories?", a: "Delhi has 8 circle rate categories: Category A (premium colonies â€” highest rate), B, C, D, E, F, G, H (unapproved colonies â€” lowest rate). Check Delhi government website or Sub-Registrar office for current category-wise circle rates for your specific colony or area." },
          ...
          { q: "Is there stamp duty exemption in Delhi?", a: "Delhi does not have a blanket stamp duty exemption but offers a 2% concession for women buyers. Some government housing schemes (DDA flats) may have different stamp duty arrangements. For SC/ST categories, there may be concessional rates â€” check with the Sub-Registrar Office." },
    ...
    gujarat: {
      ...
      seo: {
        title: "Gujarat Stamp Duty Calculator 2025 â€” Property Registration GJ | Calculatorcity",
        ...
        subtitle: "Gujarat property stamp duty â€” 4.9% + 1% registration. Affordable rates in India."
      },
      content: {
        howItWorks: `<p>Gujarat charges stamp duty at <strong>4.9% of property value</strong> â€” a unique rate slightly below 5%. Registration charges are 1%. The total transaction cost is 5.9% of property value, making Gujarat one of the more affordable states for property registration.</p>
      <p>The Gujarat Registration Department manages all property registrations through the Garvi portal (garvi.gujarat.gov.in).</p>`,
        stateSpecific: `<h2>Garvi portal â€” Gujarat property registration</h2>
      ...
      <p>Jantri is Gujarat's term for circle rate/guideline value. Jantri rates are set by the Revenue Department and vary by locality, zone, and property type. Stamp duty in Gujarat is calculated on jantri value or transaction value, whichever is higher.</p>`,
        faq: [
          ...
          { q: "How to calculate stamp duty for Ahmedabad property?", a: "For an Ahmedabad flat of â‚¹60 lakhs: Stamp duty = 4.9% Ã— â‚¹60L = â‚¹2,94,000. Registration = 1% Ã— â‚¹60L = â‚¹60,000. Total = â‚¹3,54,000. Calculation is on jantri value or â‚¹60L, whichever is higher." },
    ...
    "uttar-pradesh": {
      ...
      minimumValue: null,
      notes: "UP gives 1% discount to women. Registration capped at â‚¹1 lakh maximum in UP.",
      seo: {
        title: "UP Stamp Duty Calculator 2025 â€” Uttar Pradesh Property Registration | Calculatorcity",
        ...
        subtitle: "UP property stamp duty â€” 7% for men, 6% for women. All UP districts."
      },
      content: {
        howItWorks: `<p>Uttar Pradesh charges stamp duty at <strong>7% for men and 6% for women</strong>. Registration charges are 1% for all buyers, capped at â‚¹1 lakh maximum. UP has the highest stamp duty rate for men among major Indian states.</p>
      <p>The UP Registration Department (IGRSUP) manages property registrations through the IGRS UP portal.</p>`,
        stateSpecific: `<h2>IGRS UP â€” registration portal</h2>
      ...
      <p>Noida (Gautam Buddha Nagar) properties have higher circle rates due to proximity to Delhi. Noida and Greater Noida fall under UP jurisdiction and follow UP stamp duty rates.</p>`,
        faq: [
          { q: "What is stamp duty in Uttar Pradesh 2025?", a: "UP stamp duty is 7% for men and 6% for women. Registration charges are 1% (capped at â‚¹1 lakh). Total for men = 8%, for women = 7%. UP has the highest stamp duty for male buyers among major Indian states." },
          { q: "What is the women discount on stamp duty in UP?", a: "Women in UP pay 6% stamp duty vs 7% for men â€” a saving of 1%. Registration charges are the same 1% for all. For joint purchase, the rate is 6.5% if woman is co-owner." },
          ...
          { q: "Is UP stamp duty higher than other states?", a: "Yes, UP has one of the highest stamp duty rates in India at 7% (men) â€” same as Tamil Nadu. However, UP registration charges are 1% compared to TN's 4%, making UP total (8%) lower than TN total (11%)." },
          ...
          { q: "What is the maximum registration fee in UP?", a: "Registration charges in UP are 1% of property value but are capped at a maximum of â‚¹1 lakh. So for a â‚¹2 crore property, registration fee = 1% Ã— â‚¹2Cr = â‚¹2 lakhs, but capped at â‚¹1 lakh. This cap benefits high-value property buyers." }
        ]
      }
    },
    ...
    rajasthan: {
      ...
      seo: {
        title: "Rajasthan Stamp Duty Calculator 2025 â€” Property Registration RJ | Calculatorcity",
        ...
        subtitle: "Rajasthan stamp duty â€” 6% for men, 5% for women. Jaipur and all RJ districts."
      },
      content: {
    ...
    "west-bengal": {
      ...
      seo: {
        title: "West Bengal Stamp Duty Calculator 2025 â€” Property Registration WB | Calculatorcity",
        ...
        subtitle: "WB stamp duty â€” 6% urban, 5% rural. Kolkata and all West Bengal districts."
      },
      content: {
      ...
      <p>Kolkata falls under urban category (6% stamp duty). The WBREGINET portal manages all WB property registrations. Kolkata suburban areas in North 24 Parganas, South 24 Parganas have growing property markets.</p>`,
        faq: [
          ...
          { q: "Is Kolkata urban or rural for stamp duty?", a: "Kolkata and all municipal corporation areas are urban â€” 6% stamp duty applies. Areas under gram panchayat are rural â€” 5% stamp duty." },
          ...
          { q: "What is the circle rate in Kolkata?", a: "Circle rates in Kolkata vary significantly by zone â€” South Kolkata premium areas vs North Kolkata. Check WBREGINET for current zone-wise rates." },
    ...
    "madhya-pradesh": {
      ...
      seo: {
        title: "MP Stamp Duty Calculator 2025 â€” Madhya Pradesh Property Registration | Calculatorcity",
        ...
        subtitle: "MP property stamp duty â€” 7.5% one of highest in India. Bhopal, Indore all districts."
      },
      content: {
        howItWorks: `<p>Madhya Pradesh has one of the highest stamp duty rates in India at <strong>7.5%</strong>. Registration charges are 1%. Total transaction cost is 8.5% of property value â€” higher than most Indian states.</p>`,
        stateSpecific: `<h2>SAMPDA portal â€” MP registration</h2>
    ...
    haryana: {
      ...
      minimumValue: null,
      notes: "Haryana gives 2% discount to women â€” same as Delhi discount amount. Total: men 8%, women 6%.",
      seo: {
        title: "Haryana Stamp Duty Calculator 2025 â€” Property Registration HR | Calculatorcity",
        description: "Calculate stamp duty for Haryana property. Women pay only 5% vs 7% for men â€” 2% discount. Gurugram, Faridabad, Chandigarh registration charges.",
        h1: "Haryana Stamp Duty Calculator",
        subtitle: "Haryana stamp duty â€” women pay 5%, men pay 7%. 2% women discount in Gurugram and all HR."
      },
      content: {
        howItWorks: `<p>Haryana gives a <strong>2% stamp duty discount for women</strong> â€” women pay 5% while men pay 7%. Registration charges are 1%. Total: men pay 8%, women pay 6%.</p>
      ...
      <p>Gurugram falls under Haryana and follows HR stamp duty rates. Given high property values in Gurugram (DLF sectors, Golf Course Road, Cyber City area), the stamp duty amount can be very significant. Women save substantial amounts on Gurugram property registration.</p>`,
        faq: [
          { q: "What is stamp duty in Haryana 2025?", a: "7% for men, 5% for women. Registration 1% for all. Total: men = 8%, women = 6%. Women save 2% â€” same discount as Delhi." },
          { q: "Women discount in Haryana stamp duty?", a: "2% discount â€” women pay 5% vs men's 7%. For a â‚¹1 crore Gurugram property, women save â‚¹2 lakhs in stamp duty." },
          { q: "What is stamp duty in Gurugram?", a: "Gurugram is in Haryana â€” same HR rates apply. Men pay 7%, women pay 5% stamp duty + 1% registration for all." },
    ...
    punjab: {
      ...
      minimumValue: null,
      notes: "Punjab same as Haryana â€” 2% women discount. Men 8% total, women 6% total.",
      seo: {
        title: "Punjab Stamp Duty Calculator 2025 â€” Property Registration PB | Calculatorcity",
        ...
        subtitle: "Punjab property stamp duty â€” 7% for men, 5% for women. All Punjab districts."
      },
      content: {
        howItWorks: `<p>Punjab charges stamp duty at <strong>7% for men and 5% for women</strong> â€” a 2% discount for women buyers. Registration charges are 1% for all. Total cost: men 8%, women 6%.</p>`,
        stateSpecific: `<h2>Major Punjab property markets</h2>
      <p>Chandigarh (UT, separate rates), Mohali (Punjab â€” follows Punjab rates), Ludhiana (industrial hub), Amritsar (tourism/heritage), and Jalandhar are major property markets in Punjab.</p>`,
        faq: [
          ...
          { q: "Women discount in Punjab?", a: "Women pay 5% vs men's 7% â€” a 2% saving." },
          ...
          { q: "Is Mohali under Punjab or Chandigarh for stamp duty?", a: "Mohali (SAS Nagar) is in Punjab â€” follows Punjab stamp duty rates (7% men, 5% women). Chandigarh city follows UT rates." }
        ]
      }
    },
    ...
    kerala: {
      ...
      seo: {
        title: "Kerala Stamp Duty Calculator 2025 â€” Property Registration KL | Calculatorcity",
        ...
        subtitle: "Kerala property stamp duty â€” 8% + 2% registration. All Kerala districts."
      },
      content: {
        howItWorks: `<p>Kerala charges <strong>8% stamp duty</strong> and 2% registration charges, making the total transaction cost 10% â€” one of the higher rates in India. The Kerala Registration Department handles all property registrations through the PEARL portal.</p>`,
        ...
        faq: [
          ...
          { q: "Is stamp duty high in Kerala?", a: "Yes â€” 10% total (8%+2%) is among the higher rates in India, similar to Tamil Nadu (11%) but higher than AP (8%) and Karnataka (6%)." },
    ...
    bihar: {
      ...
      seo: {
        title: "Bihar Stamp Duty Calculator 2025 â€” Property Registration BR | Calculatorcity",
        ...
        subtitle: "Bihar property stamp duty â€” 6.3% for men, 5.7% for women. All Bihar districts."
      },
      content: {
        howItWorks: `<p>Bihar has a unique fractional stamp duty â€” <strong>6.3% for men and 5.7% for women</strong>. Registration charges are 2%. Total: men 8.3%, women 7.7%.</p>`,
        ...
        faq: [
          ...
          { q: "Women discount in Bihar?", a: "0.6% discount â€” women pay 5.7% vs men's 6.3%." },
    ...
    odisha: {
      ...
      seo: {
        title: "Odisha Stamp Duty Calculator 2025 â€” Property Registration OD | Calculatorcity",
        ...
        subtitle: "Odisha property stamp duty â€” 5% for men, 4% for women. Bhubaneswar all OD districts."
      },
      content: {
        ...
        faq: [
          ...
          { q: "Women discount in Odisha?", a: "1% discount â€” women pay 4% vs men's 5%." },
    ...
    "himachal-pradesh": {
      ...
      seo: {
        title: "HP Stamp Duty Calculator 2025 â€” Himachal Pradesh Property Registration | Calculatorcity",
        ...
        subtitle: "HP stamp duty â€” 6% for men, 4% for women. Shimla, Manali all HP districts."
      },
      content: {
        ...
        stateSpecific: `<p>HP has strict land laws â€” non-residents cannot buy agricultural land. Tourists and outsiders can buy residential property in designated areas. Check with Sub-Registrar for current rules.</p>`,
        faq: [
          ...
          { q: "Women discount HP?", a: "2% discount â€” women pay 4% vs men's 6%." },
    ...
    goa: {
      ...
      seo: {
        title: "Goa Stamp Duty Calculator 2025 â€” Property Registration Goa | Calculatorcity",
        ...
        subtitle: "Goa property stamp duty â€” 3.5% stamp duty + 3% registration. Panaji, North and South Goa."
      },
      content: {
        howItWorks: `<p>Goa has a unique property registration structure â€” <strong>stamp duty is just 3.5%</strong> but registration charges are a high 3%, making the total 6.5%. Goa uses the Portuguese-era property law tradition for some aspects of land records.</p>`,
    ...
    jharkhand: {
      ...
      seo: {
        ...
        subtitle: "Jharkhand property stamp duty â€” 4% + 3% registration. Ranchi all JH districts."
      },
      content: {
    ...
    chhattisgarh: {
      ...
      seo: {
        ...
        subtitle: "CG property stamp duty â€” 5% (men) 4% (women) + 4% registration. Raipur all CG."
      },
      content: {
        howItWorks: `<p>Chhattisgarh charges <strong>5% for men and 4% for women</strong> stamp duty. Registration charges are 4% â€” among the highest in India. Total: men 9%, women 8%.</p>`,
        ...
        faq: [
          ...
          { q: "Women discount CG?", a: "1% discount â€” women pay 4% vs men's 5%." },
    ...
    assam: {
      ...
      seo: {
        ...
        subtitle: "Assam property stamp duty â€” 8.25% + 1% registration. Guwahati all Assam."
      },
      content: {
    ...
    uttarakhand: {
      ...
      seo: {
        ...
        subtitle: "UK property stamp duty â€” 5% for men, 3.75% for women. Dehradun all UK."
      },
      content: {
        howItWorks: `<p>Uttarakhand gives women a unique discount â€” women pay <strong>3.75% stamp duty vs 5% for men</strong> (25% less). Registration charges are 2% for all.</p>`,
        ...
        faq: [
          ...
          { q: "Women discount UK?", a: "25% discount â€” women pay 3.75% vs men's 5%." },
    ...
    "jammu-kashmir": {
      ...
      seo: {
        title: "J&K Stamp Duty Calculator 2025 â€” Property Registration | Calculatorcity",
        ...
        subtitle: "J&K stamp duty â€” 5% men, 3% women. Post-2019 non-residents can buy."
      },
      content: {
        howItWorks: `<p>J&K charges <strong>5% stamp duty for men and 3% for women</strong> â€” a 2% discount. Since becoming a UT in 2019, non-residents of India can now purchase property in J&K (earlier restricted).</p>`,
        stateSpecific: `<p>This is a significant change â€” before 2019, only J&K domicile holders could buy property. Now any Indian citizen can invest in Srinagar, Jammu, or other J&K areas.</p>`,
        faq: [
          ...
          { q: "Women discount J&K?", a: "2% discount â€” women pay 3% vs men's 5%." },
    ...
    chandigarh: {
      ...
      seo: {
        title: "Chandigarh Stamp Duty Calculator 2025 â€” UT Property Registration | Calculatorcity",
        ...
        subtitle: "Chandigarh UT stamp duty â€” 6% for men, 4% for women. All Chandigarh sectors."
      },
      content: {
        ...
        stateSpecific: `<p>Chandigarh has very high property values â€” sectors near the Capitol Complex, Sector 17, and Sector 35 are premium. Circle rates are high reflecting the planned city's property values.</p>`,
        faq: [
          ...
          { q: "Women discount Chandigarh?", a: "2% discount â€” women pay 4% vs men's 6%." },
    ...
    puducherry: {
      ...
      seo: {
        ...
        subtitle: "Puducherry UT stamp duty â€” 5% + 2% registration. Separate from TN rates."
      },
      content: {
        howItWorks: `<p>Puducherry UT charges <strong>5% stamp duty and 2% registration</strong> â€” different from surrounding Tamil Nadu (7% + 4%). Total 7% vs TN's 11% makes Puducherry significantly cheaper for property registration.</p>`,
        ...
        faq: [
          ...
          { q: "Is Puducherry cheaper than Tamil Nadu for property?", a: "Yes â€” 7% total vs TN's 11% total. Saving = 4% of property value on Puducherry property." },
    ...
    ladakh: {
      ...
      seo: {
        ...
        subtitle: "Ladakh UT stamp duty â€” 5% men, 3% women. Leh Kargil all Ladakh."
      },
      content: {
        ...
        faq: [
          ...
          { q: "Can outsiders buy in Ladakh?", a: "Yes â€” since 2019 UT status, any Indian can buy." },
          { q: "Women discount Ladakh?", a: "2% discount â€” women pay 3% vs men's 5%." },
    ...
    "andaman-nicobar": {
      ...
      seo: {
        ...
        subtitle: "Andaman UT stamp duty â€” 5% + 2% registration. Strict outsider restrictions apply."
      },
      content: {
