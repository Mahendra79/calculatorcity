...
function inlineStyles({ stateColor = "#7c3aed", stateLight = "#f5f3ff", stateBorder = "#ddd6fe" } = {}) {
...
.stamp-page {
  --primary: var(--state-color);
  --primary-dark: var(--state-color);
...
function pageHtml({ slug, state, data, order }) {
  ...
  const stateColor = isState ? state.color : "#7c3aed";
  const stateLight = `${stateColor}12`;
  const stateBorder = `${stateColor}33`;
