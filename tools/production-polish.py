...
<header class="site-header">
  <div class="header-inner">
    <a class="logo" href="{index}">Claculatorcity</a>
...
def page_head(title: str, description: str, path: str, page_type: str = "WebPage") -> str:
    ...
    schema = {
        ...
        "@type": page_type,
        "name": title.replace(" | Claculatorcity", ""),
        "url": absolute(path),
        "description": description,
        "publisher": {"@type": "Organization", "name": "Claculatorcity", "url": DOMAIN},
    }
    breadcrumb = {
        "@context": "https://schema.org",
        "@type": "BreadcrumbList",
        "itemListElement": [
            ...
            {"@type": "ListItem", "position": 2, "name": title.replace(" | Claculatorcity", ""), "item": absolute(path)},
        ],
    }
    import json
...
PAGES = {
    "company/about-us.html": {
        "title": "About Us | Claculatorcity",
        "description": "Learn about Claculatorcity, our calculator quality standards, privacy-first design, Indian calculator focus, and how we keep everyday calculations clear and useful.",
        "h1": "About Claculatorcity",
        "intro": "Claculatorcity is a free calculator website built for people who want fast answers without confusing forms, outdated formulas, or unnecessary signups. The site covers worldwide calculators for math, finance, units, health, time, and science, plus a deep India section for rupee-based tax, salary, investment, property, and utility calculations.",
        "sections": [
            ("Why Claculatorcity exists", [
                "Most people use calculators at moments when they need clarity quickly: comparing loan offers, checking an exam percentage, converting a measurement, estimating tax, or planning a monthly investment. A calculator page should respect that moment. It should ask only for the values that matter, label every input clearly, show the result in a readable way, and explain the formula without turning the page into a textbook. Claculatorcity exists because many online calculators still feel cluttered, slow, or written for search engines rather than real people.",
            ...
            ("Our promise", [
                "Claculatorcity will stay focused on practical, free, browser-based calculators. We will not turn simple tools into account-gated workflows. We will not hide basic formulas. We will keep improving readability, mobile behavior, Indian number formatting, and link quality. When a topic requires professional judgement, the page will say so plainly instead of pretending that one calculation can replace a qualified adviser.",
    ...
    "company/privacy-policy.html": {
        "title": "Privacy Policy | Claculatorcity",
        "description": "Read the Claculatorcity privacy policy, including how calculator inputs are handled, what data may be collected, cookies, analytics, advertising, and user choices.",
        "h1": "Privacy Policy",
        "intro": "This privacy policy explains how Claculatorcity handles information when you use our calculator website. We write it in plain language because privacy should be understandable. The key point is that calculator results are generated in your browser, and you do not need to create an account to use the tools.",
        "sections": [
            ("Information you enter into calculators", [
                "Claculatorcity calculators are designed to run locally in your browser. When you type salary, rent, investment amount, loan amount, weight, date of birth, units, marks, or any other calculator value, the page uses JavaScript in your browser to produce the result. The normal calculator workflow does not require those values to be submitted to a Claculatorcity account or saved in a profile. You can refresh the page, change the inputs, and calculate again without signing in.",
            ...
            ("Cookies, analytics, and advertising", [
                "Claculatorcity may use cookies or similar technologies for essential site operation, analytics, security, preferences, and advertising. Analytics helps answer practical questions such as which pages are used most, which devices have layout issues, and whether search helps people find calculators. Advertising, if enabled, may use third-party scripts that follow their own policies and may set cookies to measure performance, prevent fraud, or personalize ads according to their settings.",
            ...
            ("Security and retention", [
                "No website can promise perfect security, but Claculatorcity is designed to reduce risk by avoiding unnecessary accounts and keeping calculations local where possible. We use ordinary security practices for a static website, such as limiting what data is collected, keeping dependencies purposeful, and monitoring for broken or suspicious behavior. Users should also protect themselves by keeping browsers updated and avoiding sensitive calculations on untrusted devices.",
            ...
            ("Changes to this policy", [
                ...
                "For urgent legal, tax, medical, or financial decisions, privacy is only one part of responsible use. You should also verify formulas, rates, and rules with official sources. Claculatorcity helps with calculation and explanation, but the final decision and the decision context remain yours.",
            ]),
        ],
    },
    "company/terms-and-conditions.html": {
        "title": "Terms & Conditions | Claculatorcity",
        "description": "Read the Claculatorcity terms and conditions for using free online calculators, including acceptable use, disclaimers, intellectual property, and limitations.",
        "h1": "Terms & Conditions",
        "intro": "These terms explain the rules for using Claculatorcity. By using the website, you agree to use the calculators responsibly, understand that results are educational estimates unless clearly stated otherwise, and verify important decisions with the official source or a qualified professional.",
        "sections": [
            ("Use of the website", [
                "Claculatorcity provides free online calculators and explanatory content for general education, planning, comparison, and convenience. You may use the site to calculate percentages, interest, EMI, tax estimates, unit conversions, health estimates, date differences, and other everyday values. The tools are designed for normal personal, educational, and business planning use. You do not need an account for ordinary calculator access.",
            ...
            ("Third-party links and services", [
                "The website may refer to external services, official portals, chart libraries, font providers, analytics systems, advertising networks, or sources of further information. External sites are controlled by their own operators, not by Claculatorcity. We are not responsible for their content, availability, privacy practices, pricing, advice, or transactions. Use external links with normal caution and verify that the page is official before entering sensitive information.",
    ...
    "company/blogs.html": {
        "title": "Blogs | Claculatorcity",
        "description": "Read practical Claculatorcity guides about calculators, personal finance, Indian tax tools, unit conversion, health estimates, and using results responsibly.",
        "h1": "Claculatorcity Blogs",
        "intro": "The Claculatorcity blog is a practical reading hub for people who want to understand calculator results, not just copy the final number. These guides explain how to use calculators thoughtfully, compare scenarios, and avoid common mistakes in finance, tax, health, education, and everyday math.",
        "sections": [
    ...
    "company/contact-us.html": {
        "title": "Contact Us | Claculatorcity",
        "description": "Contact Claculatorcity for calculator feedback, bug reports, correction requests, content suggestions, partnerships, and general support questions.",
        "h1": "Contact Us",
        "intro": "Have a question, correction, or suggestion for Claculatorcity? Use this page to understand the best way to contact us and what details make a report useful. Clear feedback helps us fix calculator issues faster and improve the site for everyone.",
        "sections": [
            ("Best way to reach us", [
                "For general questions, corrections, and feedback, email us at contact@claculatorcity.com. A useful message explains what page you were using, what you expected, what happened instead, and whether the issue is about formula accuracy, wording, layout, links, mobile behavior, or missing content. If the issue is India-specific, include the official source or notification if you have one. That helps us verify the rule rather than guessing.",
            ...
            ("Quick contact checklist", [
                ...
                "Thank you for helping improve Claculatorcity. A calculator website becomes stronger when users report real problems from real use: a confusing label, an outdated rule, a broken link, a result that needs better formatting, or a missing example. Those details help turn a basic tool into a reliable public resource.",
            ]),
        ],
        "extra": '<div class="contact-actions"><a class="calc-btn" href="mailto:contact@claculatorcity.com">Email Claculatorcity</a></div>',
    },
    "company/help.html": {
        "title": "Help | Claculatorcity",
        "description": "Get help using Claculatorcity calculators, search, inputs, result cards, Indian number formatting, mobile layout, privacy, and troubleshooting.",
        "h1": "Help Center",
        "intro": "This help page explains how to use Claculatorcity efficiently, how to read calculator results, and what to do if something looks wrong. Most tools are simple, but a few careful habits make the results easier to trust.",
        "sections": [
            ...
            ("Checking accuracy", [
                ...
                "For rule-based pages, confirm the effective year or state. Income tax, GST, stamp duty, electricity tariff, professional tax, small-savings interest, EPF interest, vehicle tax, and university conversion rules can change. Claculatorcity aims to keep content useful, but official portals and notifications control final decisions. If you find an outdated rule, contact us with the source.",
            ]),
            ("Troubleshooting common issues", [
                "If a calculator does not respond, make sure JavaScript is enabled. Claculatorcity calculators run in the browser, so disabling JavaScript will stop most tools. If a result looks blank, check that required fields are filled and that the value is within the allowed range. If a slider appears stuck, try typing the value directly into the input beside it. If a date result seems wrong, check whether the date is in the expected format and whether the page asks for today, a due date, a birth date, or a cutoff date.",
            ...
            ("When to ask a professional", [
                ...
                "This is not a weakness of calculators. It is the boundary between calculation and judgement. Claculatorcity helps you prepare better questions, compare scenarios, and catch mistakes before a conversation with a professional. The final decision should come from the authority that controls the matter.",
            ]),
            ("Mobile and accessibility tips", [
                "Claculatorcity is designed for mobile and desktop. On phones, use the search box, quick links, and category sections to move quickly. Tap labels carefully, use numeric keyboards where available, and scroll result sections fully before leaving the page. If a table is wide, swipe sideways inside the table area. If text appears too small because of browser zoom settings, increase the browser text size.",
            ...
            ("Getting more from Claculatorcity", [
